...
function checkDeptName() { //当焦点 离开文本框时用Ajax  检查用户是否已存在及显示 提示信息
	...
	if (check) {
		$.ajax( {
			...
			data : "name=" + nm + "&oper=update" + "&id=" + dId,
			dataType : "json",
...
function checkFaxes() {
	...
	<body>
		<s:form action="dept!doUpdate.action" id="mf" method="post"
																				...
																				<td width="46%" valign="middle">
																					<table width="100%" border="0" cellspacing="0"
																						...
																						<tr>
																							...
																							<td width="95%" class="STYLE1">
																								<span class="STYLE3">你当前的位置</span>：[人事管理]-[部门信息]-[部门修改]
																							</td>
																						</tr>
																					</table>
																				</td>
											...
											<td width="3%" height="22" bgcolor="#FFFFFF">
												...
												<table align="center"
													...
													<tr height="50">
														...
														<td align="left">
															<s:submit id="update" value="保存" cssClass="button" />
															&nbsp;&nbsp;
