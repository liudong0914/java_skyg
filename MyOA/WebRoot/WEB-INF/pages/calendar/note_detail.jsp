...
<body>
<s:form action="note!doupdate.action" method="post" name="mf" onsubmit="return check();" >
                    ...
                    <tr>
                      <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td width="95%" class="STYLE1"><span class="STYLE3">你当前的位置</span>：[我的便签]-[便签详情]</td>
                        </tr>
                      </table></td>
      ...
      <tr>
        ...
        <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" >
          <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" >
            	<s:hidden name="mynote.noteId" id="noteId"></s:hidden>
				<s:hidden name="mynote.createTime"></s:hidden>
				<s:hidden name="mynote.users.userId"></s:hidden>
      <tr>
        <td width="8" background="images/tab_12.gif">&nbsp;</td>
        <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" border="0" >
...
></s:submit>
                ...
                <td width="200" >
					...
					<button  class="button" onclick="deletenot()">删除当前便签</button>	
                </td>
               	<script type="text/javascript">
               		function deletenot(){
               			var noteId=$("#noteId").val(); //获取当前便签的ID
               			$.ajax({
               				type : "post",
               				url : "calendar/note!notedelete.action",
               				data : "noteId="+noteId,
               				dataType : "text",
               				success : function(msg){
               					location.href="note!list.action";
