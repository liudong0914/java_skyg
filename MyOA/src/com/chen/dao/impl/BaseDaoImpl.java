...
import com.chen.bean.Pager.OrderType;
...
public class BaseDaoImpl<T, PK extends Serializable> implements BaseDao<T, PK> {
	...
	public List<T> findByNameNotId(String propertyName, Object valueName,String propertyId, Object valueId){
		...
		//String hql = "from Role as role where role.roleName ="+name+" and role.roleId !="+id;
		String hql =  "from " + entityClass.getName()
		+ " as model where model."+propertyName+" ='"+valueName+"' and model."+propertyId+"!="+valueId;
